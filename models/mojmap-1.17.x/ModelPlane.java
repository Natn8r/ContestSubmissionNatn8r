...
public class ModelPlane<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "plane"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 15)
						.addBox(-0.5F, -21.5F, -10.0F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(118, 166)
						...
						.addBox(-11.0F, -26.0F, -15.0F, 2.0F, 22.0F, 35.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-51.0F, -8.0F, -14.0F, 102.0F, 3.0F, 28.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, -0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r2 = body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.0F, -3.25F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(9, 15)
						.addBox(2.0F, -3.25F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 0)
						.addBox(-2.0F, -0.25F, -0.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -23.0128F, -5.5451F, 0.2182F, 0.0F, 0.0F));

		PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(164, 159)
						.addBox(-6.0F, -21.0F, -37.0F, 12.0F, 12.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(40, 77)
						.addBox(-9.0F, -24.0F, -30.0F, 18.0F, 18.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, 4.0F, -0.0436F, 0.0F, 0.0F));

		PartDefinition prop = partdefinition.addOrReplaceChild("prop", CubeListBuilder.create(),
				PartPose.offset(0.0F, 7.3785F, -30.81F));

		PartDefinition cube_r4 = prop.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(130, 54).addBox(-18.0F, -1.0F, -0.5F, 36.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, -0.0436F, 0.0F, 0.7854F));

		PartDefinition cube_r5 = prop.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(115, 108).addBox(-18.0F, -1.0F, -0.5F, 36.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
