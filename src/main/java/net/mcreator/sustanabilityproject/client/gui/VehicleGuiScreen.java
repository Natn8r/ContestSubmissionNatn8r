...
import net.mcreator.sustanabilityproject.network.VehicleGuiButtonMessage;
...
public class VehicleGuiScreen extends AbstractContainerScreen<VehicleGuiMenu> {
	...
	public VehicleGuiScreen(VehicleGuiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("sustanability_project:textures/vehicle_gui.png");
